...
### 1.5.1 文件数据读取
#### -文件路径
文件路径包括绝对路径和相对路径，当Python程序需要读取文件时，若程序与文件在同一文件夹，则无需指定文件具体路径，仅需提供文件名，但当二者
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzE4MDM5NzU1LC0yMDk0MTMxMDM2LDE4OT
kzMjU1NjYsOTMyMTI4Mjc0LC04NDAyMzc1NDYsNjIxMzk5MDAy
LDE0Njg1MjI1NzksMTczODAyOTczMywtMTYyODg1NjcwMywtOT
YzNTEzMDQ3LDYzMDU1NjYxNCwtNzY3NTU3NTI0LDEwODQ2NjE3
MTgsLTE0MjkzMzE3NTEsLTIwMTgzNDg1ODksMzM3MTQ2MTg1LD
I2NDM5NjczMiw2MzgyNDE5MjYsOTE5NDA3MjI0LDExNTcxOTUw
MF19
-->