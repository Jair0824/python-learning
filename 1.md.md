...
+ 在``try-except``代码块中还可包含``else``代码块，包含依赖于``try``代码块成功执行的代码
	...
	```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY4NDYxMDMzNCwtMTYxODA2MDMyMCw5OD
...
MDQxNzAsODU5NzM2MDE3LDE3Nzg0NTEwNjgsMTE5MzQ4NzA4Mi
wtMTgyNDQ0Nzg0LC02ODMzMTgwMzgsLTE3NjEwMTI0NzEsLTUw
Njc3MTcwNl19
-->