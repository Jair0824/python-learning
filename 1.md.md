...
#### -子类基础创建
+ 以上文``Student()``类为例，当需要创建一个新的与``Studeng()``类有类似方法的``undergraduate_student()``类时，可使用继承。需注意在编写子类时文件中必须包含父类
	```python
	class Student():
		def __init__(self,name,age): 
			self.name=name 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjE3OTM4Mjg0LC0xNTkyMzM4MzUsLTY4Nj
cwNTA4MywxMzc3ODEyOTk2LDcwOTkzMTM1MCwxMzUxMzUzNzYy
LC0xOTM3NzY5OTg4LC0yNzAxNDEzNDcsMTc4NjYwNTkxMyw4Mz
Y2ODgzMzcsNjMxNjM2NzE2LC03NDk5MjkzOTMsMTgwMTk2NjE2
NCwyMjIwNDQ1MTAsLTE5NTIzOTI2MjAsMzIyOTU2NTIsLTU5NT
AzOTg5NSwtNTE0MTIyNTE1LDY4MTM3MTYyNywxMzg1Nzg4NjY4
XX0=
-->