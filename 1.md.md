...
### 1.5.2 文件写入
#### -写入空文件
通过在调用``open()``函数并向其提供提供第二个参数``w``可进行文件的写入，若打开的文件不存在则会自动创建；若打开的文件中已有内容则会覆盖掉原有的内容
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc0MzQ2MDk1LC0xMjM5Njg5MjkzLC03OT
gwODAwMjgsMTk0NzI0Mzg0NSwxODA2MDM5MTA5LDE1Nzg4NjYz
NzUsMTQyNTg3NzMxMiwxNjA3NTA0MTcwLDg1OTczNjAxNywxNz
c4NDUxMDY4LDExOTM0ODcwODIsLTE4MjQ0NDc4NCwtNjgzMzE4
MDM4LC0xNzYxMDEyNDcxLC01MDY3NzE3MDYsNzE4MDM5NzU1LC
0yMDk0MTMxMDM2LDE4OTkzMjU1NjYsOTMyMTI4Mjc0LC04NDAy
Mzc1NDZdfQ==
-->