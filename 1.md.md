...
+ 运行时错误也称为异常 (exception), 是指程序在运行过程中发生了意外情形而无法继续运行。每当发生错误时，Python都会创建一个异常对象。如果你编写了处理该异常的代码，程序将继续运行；如果你未对异常进行处理，程序将停止，并显示一个traceback，其中包含有关异常的报告
### 1.6.2 异常处理
#### -常见的异常
+ ``ZeroDivisionError``异常：
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNjgzMzI4Niw5ODY1Mzc0MDIsLTE0MT
M5MzU2MTAsMTYxNzk2MDY2MywtNzQzNDYwOTUsLTEyMzk2ODky
OTMsLTc5ODA4MDAyOCwxOTQ3MjQzODQ1LDE4MDYwMzkxMDksMT
U3ODg2NjM3NSwxNDI1ODc3MzEyLDE2MDc1MDQxNzAsODU5NzM2
MDE3LDE3Nzg0NTEwNjgsMTE5MzQ4NzA4MiwtMTgyNDQ0Nzg0LC
02ODMzMTgwMzgsLTE3NjEwMTI0NzEsLTUwNjc3MTcwNiw3MTgw
Mzk3NTVdfQ==
-->