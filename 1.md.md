...
+ 在``try-except``代码块中还可包含``else``代码块，包含依赖于``try``代码块成功执行的代码
	...
	```
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzM3NzU1ODcwLC0xNjE4MDYwMzIwLDk4Nj
...
NDE3MCw4NTk3MzYwMTcsMTc3ODQ1MTA2OCwxMTkzNDg3MDgyLC
0xODI0NDQ3ODQsLTY4MzMxODAzOCwtMTc2MTAxMjQ3MSwtNTA2
NzcxNzA2XX0=
-->