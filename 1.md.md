...
+ 当对``add()``函数进行修改后原测试代码可能将测试失败，如更新函数为
	...
	FAILED (errors=1)
	```
	在失败输出中，第1行输出一个字母E，它指出测试用例中有一个单元测试导致了错误，之后一行指出产生``ERROR``的函数，并在之后指出详细位置及具体错误


<!--stackedit_data:
eyJoaXN0b3J5IjpbNjQxMTIzOTE4LDkyNDc3NDk0MywxNDYwNj
YxNTY4LDU1MjM4NzE4NiwxMjIzMTY1MzQyLDE0ODQ3OTg3OTYs
MjEwNzU3OTE5NSwxMzQ1NTExNjExLC0xNjE4MDYwMzIwLDk4Nj
UzNzQwMiwtMTQxMzkzNTYxMCwxNjE3OTYwNjYzLC03NDM0NjA5
NSwtMTIzOTY4OTI5MywtNzk4MDgwMDI4LDE5NDcyNDM4NDUsMT
gwNjAzOTEwOSwxNTc4ODY2Mzc1LDE0MjU4NzczMTIsMTYwNzUw
NDE3MF19
-->