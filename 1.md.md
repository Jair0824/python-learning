...
+ 绝对路径：在一般情况下，可以直接将文件在计算机中的准确位置(即绝对路径)提供给程序，绝对路径较长时可存储在变量中，再将变量传递给程序中读取文件的函数
	...
	```
<!--stackedit_data:
eyJoaXN0b3J5IjpbODc2ODU1NTkwLC0xNzYxMDEyNDcxLC01MD
Y3NzE3MDYsNzE4MDM5NzU1LC0yMDk0MTMxMDM2LDE4OTkzMjU1
NjYsOTMyMTI4Mjc0LC04NDAyMzc1NDYsNjIxMzk5MDAyLDE0Nj
g1MjI1NzksMTczODAyOTczMywtMTYyODg1NjcwMywtOTYzNTEz
MDQ3LDYzMDU1NjYxNCwtNzY3NTU3NTI0LDEwODQ2NjE3MTgsLT
E0MjkzMzE3NTEsLTIwMTgzNDg1ODksMzM3MTQ2MTg1LDI2NDM5
NjczMl19
-->