...
+ 当对``add()``函数进行修改后原测试代码可能将测试失败，如更新函数为
	...
	FAILED (errors=1)
	```
	在失败输出中，第1行输出一个字母E，它指出测试用例中有一个单元测试导致了错误，之后一行指出产生``ERROR``的函数，并在之后指出详细位置ji


<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc1NDA4NDkyMSw5MjQ3NzQ5NDMsMTQ2MD
Y2MTU2OCw1NTIzODcxODYsMTIyMzE2NTM0MiwxNDg0Nzk4Nzk2
LDIxMDc1NzkxOTUsMTM0NTUxMTYxMSwtMTYxODA2MDMyMCw5OD
Y1Mzc0MDIsLTE0MTM5MzU2MTAsMTYxNzk2MDY2MywtNzQzNDYw
OTUsLTEyMzk2ODkyOTMsLTc5ODA4MDAyOCwxOTQ3MjQzODQ1LD
E4MDYwMzkxMDksMTU3ODg2NjM3NSwxNDI1ODc3MzEyLDE2MDc1
MDQxNzBdfQ==
-->