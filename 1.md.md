...
+ 定义类使用``class``关键字，以创建``Student``类为例
  ...
  class Student():
	  def __init__(self,name,age):
		  ...
		  self.age=age
  ```
+ 定义类后即可根据该类创建实例，创建方法为``类名()``，如``Peter=Student()``
  + ``class``后为类名，通常首字母大写
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI3MDE0MTM0NywxNzg2NjA1OTEzLDgzNj
Y4ODMzNyw2MzE2MzY3MTYsLTc0OTkyOTM5MywxODAxOTY2MTY0
LDIyMjA0NDUxMCwtMTk1MjM5MjYyMCwzMjI5NTY1MiwtNTk1MD
M5ODk1LC01MTQxMjI1MTUsNjgxMzcxNjI3LDEzODU3ODg2Njgs
MTkxMzUzNjU2MSwtMzMwMzA5NDg4LC0zNjc0Njk3OTMsNzI4Nj
IyMzc2LDM4OTMyMjk2NCwtMTYzOTE1MDA2MCwzNTAwODM3MTdd
fQ==
-->