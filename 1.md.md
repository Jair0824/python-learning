...
+ 当对``add()``函数进行修改后原测试代码可能将测试失败，如更新函数为
	...
	FAILED (errors=1)
	```
	在失败输出中，第1行输出一个字母E，它指出测试用例中有一个单元测试导致了错误，之后一行指出产生``ERROR``的函数


<!--stackedit_data:
eyJoaXN0b3J5IjpbOTI0Nzc0OTQzLDE0NjA2NjE1NjgsNTUyMz
g3MTg2LDEyMjMxNjUzNDIsMTQ4NDc5ODc5NiwyMTA3NTc5MTk1
LDEzNDU1MTE2MTEsLTE2MTgwNjAzMjAsOTg2NTM3NDAyLC0xND
EzOTM1NjEwLDE2MTc5NjA2NjMsLTc0MzQ2MDk1LC0xMjM5Njg5
MjkzLC03OTgwODAwMjgsMTk0NzI0Mzg0NSwxODA2MDM5MTA5LD
E1Nzg4NjYzNzUsMTQyNTg3NzMxMiwxNjA3NTA0MTcwLDg1OTcz
NjAxN119
-->