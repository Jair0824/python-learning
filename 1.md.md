...
+ 当父类中的方法不符合子类的要求时可以进行重写，形成一个与父类中的某个方法在名称、形参列表和返回类型上都相同，但方法体不同的子类，称为覆盖 (overriding)
	...
	class Un_student(Student):
		--snip--
		def out(self):
			printprint("He is %d years old" %self.age)
	```


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMyNDIyMDIxNyw2MzgyNDE5MjYsOTE5ND
A3MjI0LDExNTcxOTUwMCwtMTAwMTkyNzEzMSwtMTEwMjc1Mzcx
NywtMTU5MjMzODM1LC02ODY3MDUwODMsMTM3NzgxMjk5Niw3MD
k5MzEzNTAsMTM1MTM1Mzc2MiwtMTkzNzc2OTk4OCwtMjcwMTQx
MzQ3LDE3ODY2MDU5MTMsODM2Njg4MzM3LDYzMTYzNjcxNiwtNz
Q5OTI5MzkzLDE4MDE5NjYxNjQsMjIyMDQ0NTEwLC0xOTUyMzky
NjIwXX0=
-->