...
+ 在需要添加测试时只需要在定义的类中加入新的方法，以测试修改后的``add()``函数为例
	```python
	#a
	```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyOTE3ODg4MzAsOTI0Nzc0OTQzLDE0Nj
A2NjE1NjgsNTUyMzg3MTg2LDEyMjMxNjUzNDIsMTQ4NDc5ODc5
NiwyMTA3NTc5MTk1LDEzNDU1MTE2MTEsLTE2MTgwNjAzMjAsOT
