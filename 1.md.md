...
+ 使用``with``关键字打开文件
	...
	```
	关键字with在不需要访问文件后将其关闭。在调用``open()``和``close()``函数来打开和关闭文件时，如果程序存
...
在合适的时候自动将其关闭。
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAyMzc2Mzg2OCwxNzc4NDUxMDY4LDExOT
M0ODcwODIsLTE4MjQ0NDc4NCwtNjgzMzE4MDM4LC0xNzYxMDEy
NDcxLC01MDY3NzE3MDYsNzE4MDM5NzU1LC0yMDk0MTMxMDM2LD
E4OTkzMjU1NjYsOTMyMTI4Mjc0LC04NDAyMzc1NDYsNjIxMzk5
MDAyLDE0Njg1MjI1NzksMTczODAyOTczMywtMTYyODg1NjcwMy
wtOTYzNTEzMDQ3LDYzMDU1NjYxNCwtNzY3NTU3NTI0LDEwODQ2
NjE3MThdfQ==
-->