...
+ 在需要添加测试时只需要在定义的类中加入新的方法，以测试修改后的``add()``函数为例，此时函数既可以计算两数又可以计算三数，解决的
	```python
	#calc.py
	def add(a,b,c=NULL):
		if c:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU3MTA1ODI1NSwtMTQxNDU2MDQ3NSw5Mj
Q3NzQ5NDMsMTQ2MDY2MTU2OCw1NTIzODcxODYsMTIyMzE2NTM0
MiwxNDg0Nzk4Nzk2LDIxMDc1NzkxOTUsMTM0NTUxMTYxMSwtMT
YxODA2MDMyMCw5ODY1Mzc0MDIsLTE0MTM5MzU2MTAsMTYxNzk2
MDY2MywtNzQzNDYwOTUsLTEyMzk2ODkyOTMsLTc5ODA4MDAyOC
wxOTQ3MjQzODQ1LDE4MDYwMzkxMDksMTU3ODg2NjM3NSwxNDI1
ODc3MzEyXX0=
-->