...
+ 在创建子类的过程中随着添加属性和方法的增多文件会很长，可以将类的一部分作为一个独立的类提取出来，将大型类拆分成多个协同工作的小类，以``Un_student``类为例
	...
	class Base_Information():
		fer __init__(self,name,age,sex,num)	
	class Un_student(Student):
		def __init__(self,name,age,sex):
			super().__init__(self,name,age) #从父类中继承属性
			self.sex=sex #添加新的属性
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjQ3ODk1NDcsMjY0Mzk2NzMyLDYzODI0MT
kyNiw5MTk0MDcyMjQsMTE1NzE5NTAwLC0xMDAxOTI3MTMxLC0x
MTAyNzUzNzE3LC0xNTkyMzM4MzUsLTY4NjcwNTA4MywxMzc3OD
EyOTk2LDcwOTkzMTM1MCwxMzUxMzUzNzYyLC0xOTM3NzY5OTg4
LC0yNzAxNDEzNDcsMTc4NjYwNTkxMyw4MzY2ODgzMzcsNjMxNj
M2NzE2LC03NDk5MjkzOTMsMTgwMTk2NjE2NCwyMjIwNDQ1MTBd
fQ==
-->