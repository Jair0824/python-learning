...
#### -类的创建
+ 定义类使用``class``关键字，以创建``Student``类为例，定义类后即可根据该类创建实例，创建方法为``类名(c)``
  ```python
  class Student():
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMDYzMjUwODUsLTI3MDE0MTM0NywxNz
g2NjA1OTEzLDgzNjY4ODMzNyw2MzE2MzY3MTYsLTc0OTkyOTM5
MywxODAxOTY2MTY0LDIyMjA0NDUxMCwtMTk1MjM5MjYyMCwzMj
I5NTY1MiwtNTk1MDM5ODk1LC01MTQxMjI1MTUsNjgxMzcxNjI3
LDEzODU3ODg2NjgsMTkxMzUzNjU2MSwtMzMwMzA5NDg4LC0zNj
