...
class information():
	...
	def out_put(self):
		print(name + "Please enter your skills")
...
class Test_information(unittest.TestCase):
	def test_store_angle_information(self):
		...
		self.assertIn('Ball',test_student.)
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk0NzQwMjMzOCwtMTUyMTY1MzM5LC01ND
c0NzY2OTIsLTE4NjgwMDIyOTQsLTI4MTkyNTM4Niw0Mzk2MDAx
MDEsLTE5MzIxNDQ5OTgsLTE0MTQ1NjA0NzUsOTI0Nzc0OTQzLD
E0NjA2NjE1NjgsNTUyMzg3MTg2LDEyMjMxNjUzNDIsMTQ4NDc5
ODc5NiwyMTA3NTc5MTk1LDEzNDU1MTE2MTEsLTE2MTgwNjAzMj
AsOTg2NTM3NDAyLC0xNDEzOTM1NjEwLDE2MTc5NjA2NjMsLTc0
MzQ2MDk1XX0=
-->