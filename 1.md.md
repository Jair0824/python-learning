...
+ 相对路径：当所要操作的文件位于程序所在目录的其他文件夹时，可以使用相对文件路径来打开文件
	...
	--snip--
	```
+ 绝对路径：在一般情况下，可以直接将文件在计算机中的准确位置(即绝对路径)提供给程序
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU4MzgxMjg5NywtMTc2MTAxMjQ3MSwtNT
...
MzA0Nyw2MzA1NTY2MTQsLTc2NzU1NzUyNCwxMDg0NjYxNzE4LC
0xNDI5MzMxNzUxLC0yMDE4MzQ4NTg5LDMzNzE0NjE4NSwyNjQz
OTY3MzJdfQ==
-->