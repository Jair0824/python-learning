...
+ 在创建子类的过程中随着添加属性和方法的增多文件会很长，可以将类的一部分作为一个独立的类提取出来，将大型类拆分成多个协同工作的小类，以``Un_student``类为例
	...
	```
#### -多态
+ 覆盖的存在产生了继承的优点——多态，多态的优点在于当将类作为参数传向新的方法或函数时可以实现


<!--stackedit_data:
eyJoaXN0b3J5IjpbOTE3MDIxOTYsLTIwMTgzNDg1ODksMzM3MT
Q2MTg1LDI2NDM5NjczMiw2MzgyNDE5MjYsOTE5NDA3MjI0LDEx
NTcxOTUwMCwtMTAwMTkyNzEzMSwtMTEwMjc1MzcxNywtMTU5Mj
MzODM1LC02ODY3MDUwODMsMTM3NzgxMjk5Niw3MDk5MzEzNTAs
MTM1MTM1Mzc2MiwtMTkzNzc2OTk4OCwtMjcwMTQxMzQ3LDE3OD
