...
if __name__ == '__main__':
	#判断模块是否作为一个独立的程序运行
	# sys . argv 是 一 个 记 录 了 用 户 在 命 令 行 输 入 的 所 有 参 数 的 列 表。列 表 的 第 一 个 元 素 是 模 块 名 称，列表的其余元素(若存在)是用户依次输入的所有参数  
    if len(sys.argv) == 1:
        print(__doc__)  
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzgyNjYwNzQ4LDE4MDE5NjYxNjQsMjIyMD
Q0NTEwLC0xOTUyMzkyNjIwLDMyMjk1NjUyLC01OTUwMzk4OTUs
LTUxNDEyMjUxNSw2ODEzNzE2MjcsMTM4NTc4ODY2OCwxOTEzNT
M2NTYxLC0zMzAzMDk0ODgsLTM2NzQ2OTc5Myw3Mjg2MjIzNzYs
Mzg5MzIyOTY0LC0xNjM5MTUwMDYwLDM1MDA4MzcxNywtMTQ4OT
Y1NjcwNiwtMTY2NzcyMDY5MiwtMTUzMzU3MTYyNSwyMDg4MTU1
NzA4XX0=
-->