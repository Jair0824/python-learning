...
+ 定义类使用``class``关键字，以创建``Student``类为例
  ...
  + 一个类中所有方法的第一个形参始终为``slef``，是一个特殊的对象名，表示当前对象；在调用类中每一个方法时都会自动传入``self``

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MjY3NzM0MzEsMTc4NjYwNTkxMyw4Mz
...
LDE5MTM1MzY1NjEsLTMzMDMwOTQ4OCwtMzY3NDY5NzkzLDcyOD
YyMjM3NiwzODkzMjI5NjQsLTE2MzkxNTAwNjAsMzUwMDgzNzE3
XX0=
-->